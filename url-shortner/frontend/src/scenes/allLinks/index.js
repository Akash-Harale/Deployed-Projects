...
export const AllLinks = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "https://fierce-turtleneck-seal.cyclic.app/url"
        );
  ...
  return (
    <Box m="20px">
      ...
      >
        {data.length === 0 ? <CircularIndeterminate size={70} color={colors.greenAccent[500]} /> : ""}
      </Box>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <CopyToClipboard
                                textData={`https://fierce-turtleneck-seal.cyclic.app/url/${el.shortID}`}
                              />
                            </button>
                          </Box>
                        </Box>
